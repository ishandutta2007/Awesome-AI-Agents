...
with st.sidebar:
    ...
    st.markdown("- Go to github.com/ishandutta2007/Awesome-AI-Agents")
    ...
    st.markdown("- Navigate to github.com/ishandutta2007/Awesome-AI-Agents, scroll down, and report details")
