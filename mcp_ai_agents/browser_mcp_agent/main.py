...
with st.sidebar:
    ...
    st.markdown("- Go to github.com/ishandutta2007/Awesome-LLM-Agents")
    ...
    st.markdown("- Navigate to github.com/ishandutta2007/Awesome-LLM-Agents, scroll down, and report details")
