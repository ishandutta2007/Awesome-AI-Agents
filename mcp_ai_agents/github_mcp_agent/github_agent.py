...
with col1:
    repo = st.text_input("Repository", value="ishandutta2007/Awesome-LLM-Agents", help="Format: owner/repo")
with col2:
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            ...
            <li>Specify a repository (e.g., ishandutta2007/Awesome-LLM-Agents)</li>
